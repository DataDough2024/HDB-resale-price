...
# Context about HDB resale price volatility in the right column
with right_column:
    right_column.subheader("Understanding HDB Resale Price Volatility")
    right_column.write("""
    The HDB resale market in Singapore has seen price fluctuations due to factors like government cooling measures, changes in loan policies, and shifts in supply and demand. Key events, such as the introduction of the Additional Buyer’s Stamp Duty (ABSD) in 2013 and changes in economic conditions, have notably impacted buyer sentiment and market dynamics.
    """)
